Classical Atlas: English Guide Package

This is the Apple Music edition of the Classical Atlas demo. Apple Music search columns, Apple Music-oriented execution notes, and reconstructed platform logs are intentional for this edition. For the reusable platform-agnostic kit contract, use ../../specs/, ../../prompts/, and ../../templates/.

Files:
- classical_atlas_guide.en.md: English Markdown guide
- classical_atlas_guide.en.html: English static HTML ebook
- classical_atlas_playlist.en.tsv: English playlist data
